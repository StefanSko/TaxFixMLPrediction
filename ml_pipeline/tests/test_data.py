...
from data.loader import load_data, load_and_split_data
# Create test data
@pytest.fixture
def sample_csv_file():
    with tempfile.NamedTemporaryFile(suffix='.csv', delete=False) as f:
        f.write(
            b"age,income,employment_type,marital_status,time_spent_on_platform,number_of_sessions,fields_filled_percentage,previous_year_filing,device_type,referral_source,completed_filing\n")
